...
A multinomial logistic regression was fit with pacing profile as a dependent variable on the boat size, race placement in a heat or final, discipline, gender and weight class variables. Below we report the odds ratio for each variable in the model. 
...
Women were statistically less likely to follow "Even" pacing profiles. 

### Weight Class

The "Open" weight class also saw a different distribution of pacing profiles compared to the "Lightweight" class after acounting for the other variables. Holding the other variables the "Positive" and "Reverse J-Shaped" pacing profile were more likely to be used.
